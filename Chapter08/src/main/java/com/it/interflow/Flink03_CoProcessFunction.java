...
public class Flink03_CoProcessFunction {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 来自app的支付日志
        SingleOutputStreamOperator<Tuple3<String, String, Long>> appStream = env.fromElements(Tuple3.of("order-1", "app", 1000L), Tuple3.of("order-2", "app", 2000L)).assignTimestampsAndWatermarks(WatermarkStrategy.
        ...
        // 合并两个流
        appStream.connect(thirdPartyStream).keyBy(data -> data.f0, data -> data.f0).process(new CoProcessFunction<Tuple3<String, String, Long>, Tuple4<String, String, String, Long>, String>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ...
                thirdPartyEventState = getRuntimeContext().getState(new ValueStateDescriptor<Tuple4<String, String, String, Long>>(
